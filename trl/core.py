...
def masked_mean(values, mask = None, axis=None):
...
def masked_var(values, mask = None, unbiased=True):
...
def masked_whiten(values, mask = None, shift_mean=True):
