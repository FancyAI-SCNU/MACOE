...
def w_order(f, start, end):
    ...
    order_train = order[df_temp <= '2022-12-31']
    
    order_test = order[df_temp >= '2023-01-01']
    ...
    order_valid = order_test[df_temp_test <= '2023-02-28']

    order_test = order_test[df_temp_test >= '2023-03-01']
    df_temp_test = order_test.index.get_level_values(0).map(lambda x:str(x))
     
    order_test = order_test[df_temp_test <= '2023-05-01']
...
valid_path = os.path.join(data_path, "order_1/valid/")
